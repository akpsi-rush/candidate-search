...
const MobileSearchBar: FC<SearchBarProps> = ({
  candidateData,
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="w-[300px] mt-[70px] flex flex-row border-black border-[1px]">
        <select
          className="bg-blue-400 w-[100px] text-white text-[16px] border-black border-[1px] rounded-none"
          value={filterOption}
